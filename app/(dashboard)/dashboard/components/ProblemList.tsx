...
export default function ProblemList({
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden" style={{ fontFamily: "'Kalpurush', 'Roboto', sans-serif" }}>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs text-zinc-300 leading-relaxed">
                      <MathText text={p.question.length > 120 ? p.question.slice(0, 120) + "…" : p.question} />
                    </p>
