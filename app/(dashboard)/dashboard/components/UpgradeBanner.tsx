export default function UpgradeBanner() {
  return (
    <div className="relative overflow-hidden bg-card border border-border rounded-xl
      ...
      <div>
        ...
        <h3 className="text-foreground font-semibold mb-1">Unlock all 500+ problems</h3>
