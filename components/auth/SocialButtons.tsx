...
// Shared social sign-in buttons for Login and Signup pages.
...
const BTN_CLASS =
  "social-btn flex items-center justify-center gap-2 py-2.5 rounded-xl border border-zinc-700 bg-zinc-800 text-zinc-300 hover:border-zinc-500 hover:text-white text-sm"
...
export default function SocialButtons() {
  ...
  return (
    <div className="grid grid-cols-3 gap-3">
      ...
      {/* Google */}
      <button type="button" onClick={handleGoogle} className={BTN_CLASS}>
        <GoogleIcon />
        Google
      </button>
